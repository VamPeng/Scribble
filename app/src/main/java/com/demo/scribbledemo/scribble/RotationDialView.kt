...
class RotationDialView @JvmOverloads constructor(
    ...
    private class Dimensions {
        ...
        @Px
        val spaceBetweenAngleIndicators: Int = dpToPx(Companion.spaceBetweenAngleIndicators)

        @Px
        val angleIndicatorWidth: Int = dpToPx(Companion.angleIndicatorWidth)

        @Px
        val minorAngleIndicatorHeight: Int = dpToPx(Companion.minorAngleIndicatorHeight)

        @Px
        val majorAngleIndicatorHeight: Int = dpToPx(Companion.majorAngleIndicatorHeight)

        @Px
        val textPaddingBottom: Int = dpToPx(Companion.textPaddingBottom)
