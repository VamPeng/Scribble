...
final class ElementStack implements Parcelable {
    ...
    static byte[] getBytes(@NonNull Parcelable parcelable) {
        ...
        try {
            ...
            Log.d("ElementStack", "dataSize " + parcel.dataSize());
        } finally {
            parcel.recycle();
        }
        return bytes;
    ...
    EditorElement pop(@NonNull EditorElement element) {
        ...
        Log.d("ElementStack", "start pop " + element.getId());
        ...
        try {
            ...
            Log.d("ElementStack", "un parcel dataSize " + parcel.dataSize());
            EditorElement newElement = parcel.readParcelable(EditorElement.class.getClassLoader());
            return newElement;
        } finally {
            parcel.recycle();
        }
